<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <div x-data="{ open: false }">
            ...
            <button x-on:click="open = ! open" class="mt-4 underline">
                <span x-show="!open" class="text-blue-500">Read More</span>
                <span x-show="open" class="text-blue-500">Read Less</span>
            </button>
        </div>
    </x-filament::section>
</x-filament-widgets::widget>
