...
// App\Filament\Auth\LoginOPD.php
...
class LoginOPD extends AuthLogin
{
    ...
    {
        // Fetch the user based on NIP and ensure they have the 'OPD' role
        ...
        // Check if the user exists and has the 'OPD' role
        if (!$user) {
            Notification::make()
                ->title('NIP atau Password salah.')
                ->danger()
                ->send();
            throw ValidationException::withMessages([
                'login' => ['NIP tidak ditemukan atau Anda tidak memiliki akses sebagai OPD.'],
            ]);
        }
