...
use App\Filament\Resources\TugasBelajarResource\Pages;
use pxlrbt\FilamentExcel\Actions\Tables\ExportBulkAction;
use Filament\Forms\Components\SpatieMediaLibraryFileUpload;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use App\Filament\Resources\TugasBelajarResource\RelationManagers;
...
class TugasBelajarResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                TextColumn::make('pegawai.nama')->label('Nama Pegawai')->searchable()->toggleable(),
                TextColumn::make('universitas')->label('Universitas')->searchable()->toggleable(),
                TextColumn::make('prodi')->label('Program Studi')->searchable()->toggleable(),
                TextColumn::make('jenjang_tujuan')->label('Jenjang Tujuan')->searchable()->toggleable(),
                ...
                TextColumn::make('stage')
                    ->label('Tahap')->searchable()->toggleable()
                    ->formatStateUsing(
